...
MOUSE_PINCH_THRESHOLD = 40                # Pixels — pinch detected below this
MOUSE_CLICK_COOLDOWN  = 0.4              # Seconds between consecutive clicks
MOUSE_FRAME_MARGIN    = 100              # Pixels — dead border around frame edge

# ── Gesture Actions ─────────────────────────────────────────────
ACTION_DEBOUNCE_FRAMES = 6               # Consecutive frames before action fires
...
ACTION_COOLDOWNS: dict[str, float] = {
    "Peace / Victory": 0.15,             # Scroll — fast repeat allowed
    "Open Palm":       2.0,              # Screenshot — long cooldown
    "Fist":            1.5,              # Play/Pause
